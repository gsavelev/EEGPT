...
class EEGPTCalibry(pl.LightningModule):
    def __init__(self, ch_names, load_path="../checkpoint/eegpt_mcae_58chs_4s_large4E.ckp", 
                 use_lora=False, lora_rank=8, lora_alpha=32, lora_dropout=0.1,
                 max_lr=1e-3, steps_per_epoch=100, max_epochs=10,
                 channels_index=None):
        super().__init__()
        ...
        self.chans_id = target_encoder.prepare_chan_ids(ch_names)
